...
GPIO.setup(GPIO_INFR, GPIO.IN) # SETEO PUERTO COMO ENTRADA DIGITAL DEL SENSOR
GPIO.setup(16, GPIO.OUT) # SETEO PUERTO COMO SALIDA DIGITAL DEL SENSOR

puerta = "Puerta Fer"
print(puerta) 

while True:
    sensor = GPIO.input(GPIO_INFR) #LEO EL SENSOR INFLARROJO PARA SABER SI DETECTO ALGO O NO, DEVUELVE 0 SI DETECTO ALGO
 ...
 #       print("Estado actual: False")
    ...
    if sensor==0:   
        ...
        GPIO.output(16, True) # PRENDO EL LED
